    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <h3 class="text-2xl font-bold mb-4">EcommerceVue</h3>
          <p class="text-gray-400 mb-4 max-w-md">
            Your trusted online shopping destination. Discover amazing products with unbeatable prices and exceptional customer service.
          </p>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm">
          &copy; 2024 EcommerceVue. All rights reserved.
        </p>
        <div class="flex space-x-4 mt-4 md:mt-0">
          <img src="https://via.placeholder.com/40x25/4F46E5/FFFFFF?text=VISA" alt="Visa" class="h-6">
          <img src="https://via.placeholder.com/40x25/FF6B35/FFFFFF?text=MC" alt="Mastercard" class="h-6">
          <img src="https://via.placeholder.com/40x25/00457C/FFFFFF?text=PP" alt="PayPal" class="h-6">
        </div>
      </div>
    </div>
  </footer>
